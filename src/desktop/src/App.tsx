...
import { LayoutDashboard, Server, Settings as SettingsIcon, Wifi, WifiOff, Zap, Box } from 'lucide-react';
import { Dashboard, NodeControl, Settings, SubmitJob, Modules } from './pages';
